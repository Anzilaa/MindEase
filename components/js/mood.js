...
import { getFirestore, doc, setDoc, collection, query, where, getDocs } from "https://www.gstatic.com/firebasejs/10.7.2/firebase-firestore.js";
...
async function fetchMonthMoods(date) {
	...
	const q = query(moodsRef, where('__name__', '>=', start), where('__name__', '<=', end));
